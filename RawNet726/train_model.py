...
import yaml
from RawNet646.data_utils import genSpoof_list, Dataset_ASVspoof2019_train
...
def mytrain():
    ...
    train_database_path = Gconfig.TPATH72600
    dev_database_path = Gconfig.EPATH72600
    train_label_path = Gconfig.TLABEL72600
    dev_label_path = Gconfig.ELABEL72600
    batch_size = Gconfig.RAW726_MS_BATCH_SIZE
    num_epochs = Gconfig.RAW726_MS_NUM_EPOCHS
    model_save_path = Gconfig.RAW726_MS_SAVE_PATH
