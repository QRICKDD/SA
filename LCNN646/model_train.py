...
from LCNN646.data_utils import genSpoof_list, Dataset_ASVspoof2019_train
...
from LCNN646.model import Model_zoo
from RawNet4.train_model import evaluate_accuracy, train_epoch


def train():
    batch_size = Gconfig.LCNN646_MS_BATCH_SIZE
    num_epochs = Gconfig.LCNN646_MS_NUM_EPOCHS
    lr = 0.0001
    weight_decay = 0.0001
    loss = "WCE"
    eval_output = None
    ...
    is_eval = False
    # 存放模型权重的路径
    modelth = Gconfig.LCNN646_MS_SAVE_PATH
    # 训练集
    train_path = Gconfig.TPATH64600
    train_label = Gconfig.TLABEL64600
    eval_path = Gconfig.EPATH64600
    eval_label = Gconfig.ELABEL64600
