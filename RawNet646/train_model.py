...
def mytrain():
    ...
    train_database_path = Gconfig.TPATH64600
    dev_database_path = Gconfig.EPATH64600
    train_label_path = Gconfig.TLABEL64600
    dev_label_path = Gconfig.ELABEL64600
    batch_size = Gconfig.RAW_MS_BATCH_SIZE
    num_epochs = Gconfig.RAW_MS_NUM_EPOCHS
    lr = 0.0003
    weight_decay = 0.00001
    loss = "weighted_CCE"
    # 记录模型保存路径
    model_save_path = Gconfig.RAW_MS_SAVE_PATH
