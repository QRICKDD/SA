...
fontsize=15
linewidth=3
p3,=plt.plot(All_scores_self_mean,c='dodgerblue',linestyle='-',linewidth=linewidth,label="ASR-RawNet$_{56}$")
p4,=plt.plot(All_scores_other_mean,c='red',linestyle='-',linewidth=linewidth,label="ASR-RawNet$_4$")
...
plt.legend(handles=[p3,p4], loc ="lower right",fontsize=fontsize)
plt.tight_layout()
plt.savefig(r"F:\Adversarial-1D\Prove\GS-scores-56-4.png",dpi=300)
plt.show()
