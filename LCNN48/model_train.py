...
from LCNN48.data_utils import genSpoof_list, Dataset_ASVspoof2019_train
...
from RawNet48.train_model import evaluate_accuracy, train_epoch


def train():
    batch_size = Gconfig.LCNN48_MS_BATCH_SIZE
    num_epochs = Gconfig.LCNN48_MS_NUM_EPOCHS
    lr = 0.0001
    weight_decay = 0.0001
    loss = "WCE"
    eval_output = None
    ...
    is_eval = False
    # 存放模型权重的路径
    modelth = Gconfig.LCNN48_MS_SAVE_PATH
    # 训练集
    train_path = Gconfig.TPATH48000
    train_label = Gconfig.TLABEL48000
    eval_path = Gconfig.EPATH48000
    eval_label = Gconfig.ELABEL48000
