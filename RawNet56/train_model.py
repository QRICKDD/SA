...
import yaml
from RawNet726.data_utils import genSpoof_list, Dataset_ASVspoof2019_train
...
def mytrain():
    ...
    train_database_path = Gconfig.TPATH56000
    dev_database_path = Gconfig.EPATH56000
    train_label_path = Gconfig.TLABEL56000
    dev_label_path = Gconfig.ELABEL56000
    batch_size = Gconfig.RAW56_MS_BATCH_SIZE
    num_epochs = Gconfig.RAW56_MS_NUM_EPOCHS
    model_save_path = Gconfig.RAW56_MS_SAVE_PATH
    lr = 0.0003
