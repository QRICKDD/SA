...
import yaml
from RawNet4.data_utils import genSpoof_list, Dataset_ASVspoof2019_train
...
def mytrain():
    ...
    train_database_path = Gconfig.TPATH40000
    dev_database_path = Gconfig.EPATH40000
    train_label_path = Gconfig.TLABEL40000
    dev_label_path = Gconfig.ELABEL40000
    batch_size = Gconfig.RAW4_MS_BATCH_SIZE
    num_epochs = Gconfig.RAW4_MS_NUM_EPOCHS
    lr = 0.0003
    weight_decay = 0.00001
    loss = "weighted_CCE"
    # 记录模型保存路径
    model_save_path = Gconfig.RAW40000_MS_SAVE_PATH
