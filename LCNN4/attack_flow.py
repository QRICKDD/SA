...
# CW  0.998
AdvsetPath = r"F:\Adversarial-1D\AavSave\LCNN4\CW-0002-c10"
a = CW(attackdir=datasetPath, savedir=AdvsetPath, model=new_model, input_shape=(1, 1, 40000),
       c=10, lr=0.002, steps=100, is_raw=False)
a.attack()
del (a)

# DeepFool
AdvsetPath = r"F:\Adversarial-1D\AavSave\LCNN4\DeepFool-eps1e-3-myw1"
a = DeepFool(attackdir=Config.TPATH, savedir=AdvsetPath, model=new_model, input_shape=(1, 1, 40000))
a.attack(eps=0.01, myw=1, max_iter=50, verbose=False)
del (a)

# FGSM
AdvsetPath = r"F:\Adversarial-1D\AavSave\LCNN4\FGSM0015"
a = FGSM(attackdir=datasetPath, savedir=AdvsetPath, model=new_model, input_shape=(1, 1, 40000))
a.attack(eps=0.015)
del (a)

# MIFGSM
AdvsetPath = r"F:\Adversarial-1D\AavSave\LCNN4\MIFGSM10-001"
a = MIFGSM(model=new_model, attackdir=datasetPath, savedir=AdvsetPath, input_shape=(1, 1, 40000),
           eps=0.01, alpha=0.001, steps=10, decay=1, is_raw=False)
a.attack()
del (a)

AdvsetPath = r"F:\Adversarial-1D\AavSave\LCNN4\MIFGSM20-002"
a = MIFGSM(model=new_model, attackdir=datasetPath, savedir=AdvsetPath, input_shape=(1, 1, 40000),
...
# PGD
AdvsetPath = r"F:\Adversarial-1D\AavSave\LCNN4\PGD20-002"
a = PGD(attackdir=datasetPath, savedir=AdvsetPath, model=new_model, input_shape=(1, 1, 40000))
a.attack(eps=0.05, epstep=0.001, maxiter=50)
del (a)

AdvsetPath = r"F:\Adversarial-1D\AavSave\LCNN4\PGD50-005"
a = PGD(attackdir=datasetPath, savedir=AdvsetPath, model=new_model, input_shape=(1, 1, 40000))
