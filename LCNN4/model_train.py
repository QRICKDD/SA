...
from LCNN4.data_utils import genSpoof_list, Dataset_ASVspoof2019_train
...
def train():
    batch_size = Gconfig.LCNN4_MS_BATCH_SIZE
    num_epochs = Gconfig.LCNN4_MS_NUM_EPOCHS
    lr = 0.0001
    weight_decay = 0.0001
    loss = "WCE"
    eval_output = None
    ...
    is_eval = False
    # 存放模型权重的路径
    modelth = Gconfig.LCNN4_MS_SAVE_PATH
    # 训练集
    train_path = Gconfig.TPATH40000
    train_label = Gconfig.TLABEL40000
    eval_path = Gconfig.EPATH40000
    eval_label = Gconfig.ELABEL40000
